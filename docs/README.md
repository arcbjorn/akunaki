...
| Area | Document |
|------|----------|
| **Operating the backend (deploy + integrate)** | [operating/README.md](operating/README.md) |
...
| **Phase Zero evidence (durable job lifecycle / leader fencing)** | [evidence/phase-zero-job-concurrency.md](evidence/phase-zero-job-concurrency.md) |
