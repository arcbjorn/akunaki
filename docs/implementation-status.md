...
| Product job handlers | partial | partial | `connection.initial_sync`, `raw.normalize`, and `score.recompute` ship; automatic enqueue chaining (normalize → recompute) still pending |
