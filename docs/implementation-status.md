...
| Authenticated `/v1` product surface | partial | partial | login, `/v1/session`, `/v1/sleep`, `/v1/recovery`, and `/v1/today` reachable. The debug router remains a stand-in to be replaced |
